 ...
 * @author Drakeet Xu
 */
class FooterItemViewBinder : ItemViewBinder<FooterItem, FooterItemViewBinder.TextHolder>() {
  ...
  override fun onCreateViewHolder(inflater: LayoutInflater, parent: ViewGroup): TextHolder {
    return TextHolder(inflater.inflate(R.layout.item_footer_view, parent, false))
  }
